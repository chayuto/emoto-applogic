...
public class adsDetailsFragment extends Fragment {
     ...
     * @return A new instance of fragment adsDetailsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static adsDetailsFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ads_details, container, false);

        TextView textView = (TextView) view.findViewById(R.id.fragmentTextView);
        textView.setText(mParam1);

        Button mButton = (Button) view.findViewById(R.id.btnBack);
        mButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // here you set what you want to do when user clicks your button,
                // e.g. launch a new activity
                Log.d("Fragment","BackBtnCLicked");
